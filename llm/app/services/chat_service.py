...
from use_query import rewrite_query, generate_answer, check_hallucination, is_popup_store_question, search_and_cohere_rerank, cohere_rerank_only
...
def generate_chat(user_message: str) -> str:
    ...
    reranked_results = search_and_cohere_rerank(query, vectorstore)
